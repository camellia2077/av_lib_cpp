// view/imgui/impl/ui_config.hpp
#ifndef U_I_CONFIG_HPP
#define U_I_CONFIG_HPP

#include "app/application.hpp" // 包含此文件以使用结果模型
#include <string>
#include <string_view>
// 这个文件现在包含了所有的状态消息文本。
...
// --- 导出区域 ---
constexpr const char *ExportSectionHeader = "导出当前库到 .txt";
constexpr const char *ExportInputHint = "输出路径(留空则output.txt)";
constexpr const char *ExportButton = "导出";
...
constexpr std::string_view ErrorIdInvalid =
