// view/imgui/impl/im_gui_view.cpp
...
bool ImGuiView::init() {
  ...
  window_ =
      glfwCreateWindow(600, 500, UIConfig::MainWindowTitle, nullptr, nullptr);
  if (window_ == nullptr)
    return false;
  ...
  io.Fonts->AddFontFromFileTTF(UIConfig::FontPath, UIConfig::DefaultFontSize,
